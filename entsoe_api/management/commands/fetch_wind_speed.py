...
HOURLY_VARIABLE = "wind_speed_120m"
...
def _build_openmeteo_client(cache_seconds: int, request_retries: int):
    ...
    cache_session = requests_cache.CachedSession(
        str(cache_dir / "openmeteo_wind_speed"),
...
class Command(BaseCommand):
    help = (
        "Fetch Open-Meteo hourly 120m wind speed for one country or all "
    ...
    def fetch_batch_with_retry(
        ...
        for attempt in range(max_retries):
            try:
                ...
                return _responses_to_dataframe(countries, responses)
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(self.style.SUCCESS("Open-Meteo Wind Speed Fetch"))
        self.stdout.write(self.style.SUCCESS("=" * 70))
        ...
        for chunk_start, chunk_end in date_chunks:
            for batch in country_batches:
                ...
                if dry_run:
                    ...
                    written = save_country_wind_speed_df(df)
