...
OPENAI_CHART_QUERY_CONVERSATION_TTL = int(os.getenv("OPENAI_CHART_QUERY_CONVERSATION_TTL", "86400"))
OPENAI_CHART_QUERY_MAX_STORED_MESSAGES = int(os.getenv("OPENAI_CHART_QUERY_MAX_STORED_MESSAGES", "12"))
OPENAI_CHART_QUERY_MAX_CONTEXT_MESSAGES = int(os.getenv("OPENAI_CHART_QUERY_MAX_CONTEXT_MESSAGES", "6"))
