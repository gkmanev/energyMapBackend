...
# Neighboring control areas for ENTSO-E cross-border flow queries (A11)
# This map should list DIRECT neighbors for each ISO/BZN we support. The
# fetch_flows management command will use this map to generate bidirectional
# neighbor pairs. Keep entries symmetric where applicable.
ENTSOE_NEIGHBORS_BY_COUNTRY = {
    "AL": {"ME", "RS", "MK", "GR"},
    "AT": {"CH", "DE", "CZ", "SK", "HU", "SI", "IT"},
    "BA": {"HR", "RS", "ME"},
    "BE": {"FR", "NL", "DE", "GB", "LU"},
    "BG": {"RO", "GR", "TR", "RS", "MK"},
    "BY": {"PL", "UA", "LT", "LV"},
    ...
    "CY": set(),
    "CZ": {"DE", "PL", "SK", "AT"},
    "DE": {"DK", "NL", "BE", "LU", "FR", "CH", "AT", "CZ", "PL", "SE", "NO"},
    "DK": {"DE", "SE", "NO", "NL"},
    "EE": {"LV", "FI"},
    "ES": {"PT", "FR"},
    "FI": {"SE", "EE"},
    "FR": {"BE", "LU", "DE", "CH", "IT", "ES", "GB"},
    "GB": {"IE", "FR", "BE", "NL", "NO", "DK"},
    "GR": {"BG", "MK", "AL", "TR", "IT"},
    "HR": {"SI", "HU", "RS", "BA", "ME"},
    "HU": {"AT", "SK", "UA", "RO", "RS", "HR", "SI"},
    "IE": {"GB"},
    "IT": {"FR", "CH", "AT", "SI", "GR", "MT"},
    "LT": {"LV", "PL", "BY", "SE"},
    "LU": {"BE", "FR", "DE"},
    "LV": {"EE", "LT", "BY"},
    "MD": {"RO", "UA"},
    ...
    "PT": {"ES"},
    "RO": {"HU", "RS", "BG", "MD", "UA"},
    "RS": {"HU", "RO", "BG", "MK", "BA", "ME", "AL", "HR", "XK"},
    "SE": {"NO", "FI", "DK", "PL", "DE", "LT"},
    "SI": {"AT", "HU", "HR", "IT"},
    "SK": {"CZ", "PL", "UA", "HU", "AT"},
    "TR": {"BG", "GR", "GE"},
