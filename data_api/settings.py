...
CLAUDE_CHAT_TIMEOUT = int(os.getenv("CLAUDE_CHAT_TIMEOUT", "30"))
CLAUDE_CHAT_MAX_OUTPUT_TOKENS = int(os.getenv("CLAUDE_CHAT_MAX_OUTPUT_TOKENS", "1100"))
CLAUDE_CHAT_CONVERSATION_TTL = int(os.getenv("CLAUDE_CHAT_CONVERSATION_TTL", "86400"))
CLAUDE_CHAT_MAX_STORED_MESSAGES = int(os.getenv("CLAUDE_CHAT_MAX_STORED_MESSAGES", "12"))
CLAUDE_CHAT_MAX_CONTEXT_MESSAGES = int(os.getenv("CLAUDE_CHAT_MAX_CONTEXT_MESSAGES", "6"))
ANONYMOUS_CHAT_PROMPT_LIMIT = int(os.getenv("ANONYMOUS_CHAT_PROMPT_LIMIT", "3"))
ANONYMOUS_CHAT_PROMPT_WINDOW_SECONDS = int(
    os.getenv("ANONYMOUS_CHAT_PROMPT_WINDOW_SECONDS", str(24 * 60 * 60))
)
